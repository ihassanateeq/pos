...
if (auth == undefined) {
  ...
  $(document).ready(function () {
        ...
        data.forEach((item) => {
          ...
          let item_info = `<div class="col-lg-2 box ${item.category}"
            ...
            item.quantity
                    ...
                    ${
                      item.quantity < 10
                        ? `<div class="widget-panel widget-style-2 bg-danger text-white">`
                        : `<div class="widget-panel widget-style-2 text-muted">`
                    }
    ...
    // hsn 1 | logic for searching raw material in products feature dialog box
